    ...
    <div class="cc-container">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="acc-benefits">
                <span>Benefits</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span>
            </button>
            <div class="cc-accordion-content" id="acc-benefits">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="acc-service">
                <span>Service Areas</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span>
            </button>
            <div class="cc-accordion-content" id="acc-service">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="acc-eligibility">
                <span>Eligibility</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span>
            </button>
            <div class="cc-accordion-content" id="acc-eligibility">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="acc-expectations">
                <span>Expectations &amp; Required Program Aspects</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span>
            </button>
            <div class="cc-accordion-content" id="acc-expectations">
                ...
                <ul>
                    ...
                    <li>Commit to 1 lunch and learn event even a semester.</li>
...
<div class="cc-section cc-section-alt">
    <div class="cc-container">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-1"><span>What is the College Corps Program?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-1">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-2"><span>Who is eligible to participate in the Program?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-2">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-3"><span>What types of service opportunities are available?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-3">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-4"><span>How many hours do Fellows need to complete?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-4">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-5"><span>What kind of benefits do Fellows receive?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-5">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-6"><span>How do I apply for the Program?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-6">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-7"><span>What training or support is provided to Fellows?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-7">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-8"><span>What kinds of organizations partner with the Program?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-8">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-9"><span>Can I participate if I have a part-time job or other commitments?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-9">
        ...
        <div class="cc-accordion-item">
            <button class="cc-accordion-header" aria-expanded="false" aria-controls="faq-10"><span>Is transportation assistance provided?</span> <span class="cc-accordion-icon" aria-hidden="true">▼</span></button>
            <div class="cc-accordion-content" id="faq-10">
