...
<!-- Hero Section -->
<div class="cc-hero"><img alt="College Corps" src="https://cec.ucmerced.edu/sites/g/files/ufvvjh561/f/documents/collegecorps/college_corps_main_page.png" /></div>
...
<div class="cc-section">
	<div class="cc-container">
		...
		<div class="cc-video-container"><iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" frameborder="0" height="315" src="https://www.youtube.com/embed/jRgHjsgR4iQ?si=UjJS6j5ulTTv1uGH" width="560"></iframe></div>
	</div>
</div>
...
<div class="cc-section cc-section-alt">
	<div class="cc-container">
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>Benefits</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>Service Areas</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>Eligibility</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>Expectations &amp; Required Program Aspects</span> <span class="cc-accordion-icon">▼</span></button>
...
<div class="cc-section">
	<div class="cc-container">
		...
		<div class="cc-cohort-selector-container"><label class="cc-cohort-selector-label" for="cohortSelect">Select a Cohort to Learn More:</label> <select class="cc-cohort-select" id="cohortSelect"><option value="">-- Choose a Cohort --</option><option value="cohort2">Cohort 2 (2023-2024)</option><option value="cohort3">Cohort 3 (2024-2025)</option><option value="cohort4">Cohort 4 (2025-2026)</option><option value="cohort5">Cohort 5 (2026-2027)</option> </select></div>
		<!-- Cohort 2 Content -->
		...
		<div class="cc-cohort-content" id="cohort4">
			...
			<div class="cc-map-container"><img alt="Cohort 4 Host Sites Map" src="https://cec.ucmerced.edu/sites/cec.ucmerced.edu/files/page/images/map_ss_0.png" /> <a class="cc-btn" href="https://www.google.com/maps/d/edit?mid=13OMlFhUbYOvoUY6LaD38tyz01H2trJY&amp;usp=sharing" target="_blank">VIEW INTERACTIVE MAP</a></div>
		</div>
		<!-- Cohort 5 Content -->
		...
		<div class="cc-cohort-content" id="cohort5">
			...
			<div style="text-align: center; margin: 30px 0;"><a class="cc-btn" href="https://ucmerced.az1.qualtrics.com/jfe/form/SV_87Xjan3yma6oXzw" target="_blank">SUBMIT STUDENT INTEREST FORM</a></div>
...
<div class="cc-section cc-section-alt">
	<div class="cc-container">
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>What is the College Corps Program?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>Who is eligible to participate in the Program?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>What types of service opportunities are available?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>How many hours do Fellows need to complete?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>What kind of benefits do Fellows receive?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>How do I apply for the Program?</span> <span class="cc-accordion-icon">▼</span></button>
			...
			<div class="cc-accordion-content">
				...
				<p>To stay informed on current updates please continue to visit our College Corps website and follow us on Instagram <a href="https://www.instagram.com/ucmcollegecorps/?igsh=enh5eWVxaGtleGRj&amp;utm_source=qr#" style="color: #002856; font-weight: bold;" target="_blank">@ucmcollegecorps!</a></p>
			</div>
		</div>

		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>What training or support is provided to Fellows?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>What kinds of organizations partner with the Program?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>Can I participate if I have a part-time job or other commitments?</span> <span class="cc-accordion-icon">▼</span></button>
		...
		<div class="cc-accordion-item"><button class="cc-accordion-header"><span>Is transportation assistance provided?</span> <span class="cc-accordion-icon">▼</span></button>
