...
<title>Pathways to Public Service and Civic Engagement</title>
<style type="text/css">
        body {
        ...
        .pathways-cta a.survey-link:hover {
...
<div class="pathways-page-container">
    ...
    <div class="pathways-cta" role="note">
        ...
        <a class="survey-link" href="https://stanforduniversity.qualtrics.com/jfe/form/SV_2sO52GgyYDCVUkm" target="_blank">Take the Pathways Survey (opens in new tab)</a>
    </div>
        ...
        <ol class="acc_list">
            <li>
                ...
                <div class="acc_content" id="acc-content-1" role="region" aria-labelledby="acc-btn-1">
                    ...
                    <div class="button-row">
                        ...
                        <div class="volunteer">
                            <h4><a href="https://www.kidsdiscoverystation.org/">Kids Discovery Station</a></h4>
                        </div>
                        <div class="volunteer">
                            <h4><a href="https://cec.ucmerced.edu/college-corps-directory">CollegeCorps</a></h4>
                        </div>
                    </div>
                    <div class="button-row">
                        <div class="volunteer">
            ...
            <li>
                ...
                <div class="acc_content" id="acc-content-2" role="region" aria-labelledby="acc-btn-2">
                    ...
                    <div class="button-row">
                        ...
                        <div class="volunteer">
                            <h4><a href="https://www.google.com/search?q=Shelters+Near+Me">Search for Local Shelters</a></h4>
                        </div>
                    </div>
                    <div class="button-row">
                        <div class="volunteer">
            ...
            <li>
                <button
                    ...
                    onclick="toggleAccordion(this)"
                    onkeydown="handleAccKey(event, this)"
                >Community Organizing and Activism</button>
                <div class="acc_content" id="acc-content-3" role="region" aria-labelledby="acc-btn-3">
                    ...
                    <div class="button-row">
                        <div class="volunteer">
                            <h4><a href="https://calpirgstudents.org/">CALPIRG Students</a></h4>
                        </div>
                        <div class="volunteer">
                            <h4><a href="https://www.instagram.com/imm_rootsucm/">99Rootz</a></h4>
                        </div>
                        <div class="volunteer">
                            <h4><a href="https://mercednaacp.com/">NAACP Merced County</a></h4>
                        </div>
                    </div>
                    <div class="button-row">
                        <div class="volunteer">
                            <h4><a href="https://www.instagram.com/valleynatives4change/">Valley Natives for Change</a></h4>
                        </div>
                        <div class="volunteer">
                            <h4><a href="https://justiceco.org/">Central Valley Justice Coalition</a></h4>
                        </div>
                        <div class="volunteer">
                            <h4><a href="https://www.countyofmerced.com/4104/A-Community-Counteracting-Tobacco-ACCT-C">Merced County ACCT Coalition</a></h4>
                        </div>
                    </div>
                    <ul class="examples">
            ...
            <li>
                <button
                    ...
                    id="acc-btn-4"
                    aria-expanded="false"
                    aria-controls="acc-content-4"
                    onclick="toggleAccordion(this)"
                    onkeydown="handleAccKey(event, this)"
                >Community-Engaged Learning and Research</button>
                <div class="acc_content" id="acc-content-4" role="region" aria-labelledby="acc-btn-4">
            ...
            <li>
                <button
                    ...
                    id="acc-btn-5"
                    aria-expanded="false"
                    aria-controls="acc-content-5"
                    onclick="toggleAccordion(this)"
                    onkeydown="handleAccKey(event, this)"
                >Policy and Governance</button>
                <div class="acc_content" id="acc-content-5" role="region" aria-labelledby="acc-btn-5">
                    ...
                    <div class="button-row">
                        ...
                        <div class="volunteer">
                            <h4><a href="https://ballotpedia.org/Who_represents_me">Find Your Representatives</a></h4>
                        </div>
                    </div>
                    <div class="button-row">
                        <div class="volunteer">
            ...
            <li>
                <button
                    ...
                    id="acc-btn-6"
                    aria-expanded="false"
                    aria-controls="acc-content-6"
                    onclick="toggleAccordion(this)"
                    onkeydown="handleAccKey(event, this)"
                >Social Entrepreneurship and Corporate Social Responsibility</button>
                <div class="acc_content" id="acc-content-6" role="region" aria-labelledby="acc-btn-6">
    ...
    <p><strong>Source:</strong> Adapted from Stanford University's <a href="https://haas.stanford.edu/about/our-approach/pathways-public-service-and-civic-engagement" rel="noopener noreferrer" target="_blank">Haas Center for Public Service (opens in new tab)</a>.</p>
</div>
