...
<style type="text/css">.ylp-capstone-page * {
  ...
  .ylp-capstone-content-box h2:first-of-type {
    margin-top: 0;
  }

  .ylp-capstone-content-box p {
    font-size: 1.1rem;
    line-height: 1.8;
    color: #555;
  ...
  .ylp-capstone-content-box p:last-child {
    margin-bottom: 0;
  }

  .ylp-capstone-content-box ol {
    margin-left: 2rem;
    margin-bottom: 1.5rem;
  }

  .ylp-capstone-content-box li {
    font-size: 1.1rem;
    line-height: 1.8;
    color: #555;
    margin-bottom: 1rem;
  ...
  .ylp-capstone-content-box strong {
    color: #0f2d52;
  }

  .ylp-capstone-content-box a {
    color: #0f2d52;
    font-weight: bold;
    text-decoration: underline;
  }

  .ylp-capstone-content-box a:hover {
    color: #dbaa00;
  }

  .ylp-capstone-content-box a:focus-visible {
  ...
  .ylp-capstone-highlight-box p:last-child {
    margin-bottom: 0;
  }

  .ylp-capstone-highlight-box strong {
    color: #0f2d52;
  }

  /* Button */
  .ylp-capstone-button-wrap {
    text-align: center;
    margin: 2rem 0 1rem;
  }
  ...
  .ylp-capstone-button:focus-visible {
    outline: 3px solid #dbaa00;
    outline-offset: 2px;
  }

  /* Contact line */
  .ylp-capstone-contact {
    text-align: center;
    font-size: 1rem;
    color: #555;
    margin-bottom: 2rem;
  ...
  .ylp-capstone-contact a {
    color: #0f2d52;
    font-weight: bold;
    text-decoration: underline;
  }

  .ylp-capstone-contact a:hover {
    color: #dbaa00;
  }

  .ylp-capstone-contact a:focus-visible {
    outline: 3px solid #dbaa00;
    outline-offset: 2px;
    border-radius: 2px;
  }
